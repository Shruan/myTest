                        ...
                        <ul class="nav nav-sidebar">
                            ...
                            <li class="nav-parent">
                                ...
                                <ul class="nav nav-children">
                                    <li><a href="<?php echo U('index/page-profile');?>"><span class="text">娱乐任务</span></a></li>
                                    <li><a href="page-activity.html"><span class="text">团队招募</span></a></li>
                                    <li><a href="page-timeline.html"><span class="text">寻物任务</span></a></li>
                                ...
                                <div class="bk-padding-left-20 bk-padding-right-20">
                                    <a class="bk-bg-very-light-gray bk-bg-lighten bk-padding-off-top bk-padding-off-bottom">
                                        <div class="pull-left bk-margin-top-10 bk-margin-right-10">
                                            <div class="bk-avatar">
                                                <img src="/Public/img/avatar1.jpg" alt="" class="img-circle bk-img-60 bk-border-off" />
                                            </div>
                                        </div>
                                ...
                                <div class="bk-padding-left-20 bk-padding-right-20">
                                    <a class="bk-bg-very-light-gray bk-bg-lighten bk-padding-off-top bk-padding-off-bottom">
                                        <div class="pull-right bk-margin-top-10 bk-margin-left-10">
                                            <div class="bk-avatar">
                                                <img src="/Public/img/avatar.jpg" alt="" class="img-circle bk-img-60 bk-border-off" />
                                            </div>
                                        </div>
                                        <div class="bk-fg-inverse bk-margin-top-10">
                        ...
                        <div class="panel-body">
                            <a class="bk-bg-white bk-padding-off-top bk-padding-off-bottom">
                                <div class="row">
                                    <div class="col-xs-3 bk-vcenter text-center bk-padding-10">
                                        <div class="bk-avatar">
                                            <img src="/Public/img/avatar1.jpg" alt="" class="img-circle bk-img-40 bk-border-primary bk-border-2x bk-border-darken">
                                        </div>
                                    </div>
                            ...
                            <a class="bk-bg-white bk-padding-off-top bk-padding-off-bottom">
                                <div class="row">
                                    <div class="col-xs-3 bk-vcenter text-center bk-padding-10">
                                        <div class="bk-avatar">
                                            <img src="/Public/img/avatar2.jpg" alt="" class="img-circle bk-img-40 bk-border-warning bk-border-2x bk-border-darken">
                                        </div>
                                    </div>
                                    <div class="col-xs-9 bk-vcenter">
                            ...
                            <a class="bk-bg-white bk-padding-off-top bk-padding-off-bottom">
                                <div class="row">
                                    <div class="col-xs-3 bk-vcenter text-center bk-padding-10">
                                        <div class="bk-avatar">
                                            <img src="/Public/img/avatar2.jpg" alt="" class="img-circle bk-img-40 bk-border-danger bk-border-2x bk-border-darken">
                                        </div>
                                    </div>
                                    <div class="col-xs-9 bk-vcenter">
                                ...
                                <div class="panel-heading text-left bk-bg-primary bk-fg-white bk-padding-top-10 bk-padding-bottom-10">
                                    <div class="row">
                                        <div class="col-xs-4 bk-vcenter">
                                            <div class="bk-avatar">
                                                <img src="/Public/img/avatar.jpg" alt="" class="img-circle bk-img-80 bk-border-white bk-border-3x" />
                                            </div>
                                        </div>
                                        ...
                                        <li>
                                            <div class="timeline-box">
                                                ...
                                                <div class="img-timeline">
                                                    <a class="img-thumbnail lightbox" href="/Public/img/gallery/photo6.jpg" data-plugin-options='{ "type":"image" }'>
                                                        <img class="img-responsive" width="215" src="/Public/img/gallery/photo6.jpg">
																<span class="zoom">
