    ...
    <section>
        ...
        <ul>
            <?php if(is_array($projects)): $i = 0; $__LIST__ = $projects;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$project): $mod = ($i % 2 );++$i;?><li>
                    ...
                    <span ><a href="/index.php/Home/Projectad/send_pid/pid/<?php echo ($project["pro_id"]); ?>"><?php echo ($project["pro_title"]); ?></a></span>
...
<div class="consultDiv">
    <form class="reg" action="<?php echo U('Projectad/issue');?>" method="post">
