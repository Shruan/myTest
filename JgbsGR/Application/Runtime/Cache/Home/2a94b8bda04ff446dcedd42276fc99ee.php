...
<div id="banner">
    <div class="img">
        <ul><!--无序列表标签-->
            <li><img src="/Public/front/pictures/banner5.jpg" alt="广告"></li>
            <li><img src="/Public/front/pictures/banner1.jpg" alt="广告"></li>
            <li><img src="/Public/front/pictures/banner2.jpg" alt="广告"></li>
            <li><img src="/Public/front/pictures/banner3.jpg" alt="广告"></li>
            <li><img src="/Public/front/pictures/banner4.jpg" alt="广告"></li>
            <li><img src="/Public/front/pictures/banner5.jpg" alt="广告"></li>
            <li><img src="/Public/front/pictures/banner1.jpg" alt="广告"></li>
        </ul>
    </div>
...
<div class="clearfix">
    ...
    <div class="contentDiv">
        <div class="content">
            <ul>
                <a href="<?php echo U('Projectteam/all_projectteam');?>" class="clearfix2More">更多内容</a>
        ...
        <div class="content">
            <ul>
                <a href="<?php echo U('Projectfind/all_projectfind');?>" class="clearfix2More">更多内容</a>
        ...
        <div class="content">
            <ul>
                <a href="<?php echo U('Projectad/all_projectad');?>" class="clearfix2More">更多内容</a>
...
<div class="clearfix2">
    <section>
        <h4>项目委托</h4><a href="<?php echo U('Project/all_project');?>" class="clearfix2More">更多项目</a>
        <ul>
            <?php if(is_array($projects)): $i = 0; $__LIST__ = array_slice($projects,0,5,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$project): $mod = ($i % 2 );++$i;?><li>
                    <span><?php echo ($project["pro_id"]); ?></span>
                    <span ><a href="/index.php/Home/Index/../Project/send_pid/pid/<?php echo ($project["pro_id"]); ?>"><?php echo ($project["pro_title"]); ?></a></span>
    ...
    <aside>
        <h4>排名</h4>
        <ul>
            <?php if(is_array($maxUser)): $i = 0; $__LIST__ = $maxUser;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$maxUser): $mod = ($i % 2 );++$i;?><li><img src="/Public/front/images/head1.png" style="height: 40px;width: 40px;margin: 5px 0 5px 20px;" />
                    <a href="#"><?php echo ($maxUser["user_username"]); ?></a><span class="countNum"><?php echo ($maxUser["user_pro_num"]); ?></span>
                </li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
    </aside>
</div>
...
<div class="consultDiv">
    <h4>咨询/交流版块</h4><a href="<?php echo U('Consultation/all_Consultation');?>" class="clearfix2More">更多咨询</a>
    <ul>
        <?php if(is_array($consults)): $i = 0; $__LIST__ = $consults;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$consult): $mod = ($i % 2 );++$i;?><li>
                ...
                <span ><a href="/index.php/Home/Index/../Consultation/send_cid/cid/<?php echo ($consult["cst_id"]); ?>"><?php echo ($consult["cst_title"]); ?></a></span>
...
<script>
    $(document).ready(function(){
        ...
        $('.rightBtn').click(function(){
            ...
            $('.img ul').animate({'left':-750*index+"px"},1000,function(){
                if(index==6){
                    index=1;
                    $('.img ul').css("left","-750px");
                }
            });
            //eq（index）找到对应序列号为index的li
            $('.icon ul li').eq(index2).addClass('curr').siblings().removeClass('curr');
        });
        $('.leftBtn').click(function(){
            index--;
            index2--;if(index2<0){index2=4}
            $('.img ul').animate({'left':-750*index+"px"},1000,function(){
                if(index==0){
                    index=5;
                    $('.img ul').css("left","-3750px");
                }
            });
            //eq(index)找到对应序列号为index的li
            $('.icon ul li').eq(index2).addClass('curr').siblings().removeClass('curr');
        ...
        function autoplay(){
            timer = setInterval(function(){
                ...
                index2++;
                if(index2>4){index2=0}
                $('.img ul').animate({'left':-750*index+"px"},2000,function(){
                    if(index==6){
                        index=1;
                        $('.img ul').css("left","-750px");
                    }
