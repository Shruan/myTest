            ...
            <ul>
                ...
                <?php if(is_array($w_projects)): $i = 0; $__LIST__ = $w_projects;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$w_project): $mod = ($i % 2 );++$i;?><li class="pro_li">
                        ...
                        <button class="btn btn-warning spbtn" name="<?php echo ($w_project["pro_id"]); ?>"  >
                            <a href=" /index.php/Home/Index/pass_btn/pro_id/<?php echo ($w_project["pro_id"]); ?>">通过</a>
                        </button>
                        <button class="btn btn-warning spbtn" name="<?php echo ($w_project["pro_id"]); ?>"  >
                            <a href=" /index.php/Home/Index/false_btn/pro_id/<?php echo ($w_project["pro_id"]); ?>">不通过</a>
                        </button>
    ...
    <div style="position:relative;">
        <ul>
            ...
            <?php if(is_array($a_projects)): $i = 0; $__LIST__ = $a_projects;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a_project): $mod = ($i % 2 );++$i;?><li class="pro_li">
                    ...
                    <button class="btn btn-warning spbtn2 spbtn" ><a href=" /index.php/Home/Index/del_btn/pro_id/<?php echo ($a_project["pro_id"]); ?>">删除</a></button>
                </li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
        <a href="#" style="margin: 10px 350px; position: absolute;">1</a>
    </div>
...
<script>
       $(document).ready(function(){
           ...
           $('.edit-btn').on('click',function(event){
               ...
               $.ajax({
                   type: "POST",
                   url:"/index.php/Home/Index/edit_btn",
                   data: {
                       "uid": that.attr("rel"),
                   },
                   dataType:'json',
...
//               $.getJSON('/index.php/Home/Index/edit_btn',{pro_title:$pro_title,pro_content:$pro_content},function(json){
//                   if(json.status==1){
//                       alert('获取成功 ');
//                   }else {
//                       alert('  添加失败 ');
//                   }
           ...
           $('.sub').on('click',function(){
               ...
               $.ajax({
                   type: "POST",
                   url:"/index.php/Home/Index/save_btn",
                   data: {
                       "uid": that.val(),
                       "pro_title":$('.ipt1').val(),
								...
								<ul class="nav nav-sidebar">
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li><a href="<?php echo U('index/project-team');?>" target="_self" ><span class="text"> 团队招募</span></a></li>
											<li><a href="<?php echo U('index/project-find');?>" target="_self"><span class="text"> 寻物任务</span></a></li>
											<li><a href="<?php echo U('index/project-ad');?>" target="_self"><span class="text"> 商业广告</span></a></li>
									...
									<!--</li>-->
									<li>
										<a href="<?php echo U('index/user-information');?>" target="_self">
