...
<h4 style="position: relative;margin-left: 60px;">用户个人信息：</h4>
<div style="padding-bottom: 30px;width: 800px;background: white;margin-left: 5%; border-radius: 10px; ">
    <div style="position:relative;">
        <ul>
            <div class="pro_label"><span>编号</span>
                <span style="left: 10px;">用户名</span>
                <span style="left: 25px;">性别</span>
                <span style="left: 60px">联系电话</span>
                <span class="pro_label2" style="left: 85px;position: relative;">年龄</span>
                <span class="pro_label2" style="left: 75px;">完成项目数量</span></div>
            <?php if(is_array($results)): $i = 0; $__LIST__ = $results;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$result): $mod = ($i % 2 );++$i;?><li class="pro_li" rel="<?php echo ($result["cst_id"]); ?>">
                    <span class="sp1"><?php echo ($result["user_id"]); ?></span>
                    <span class="sp2" ><a href="#" title=""><?php echo ($result["user_username"]); ?></a></span>
                    <span class="sp2" style="position: absolute;left: 85px"><a href="#" title=""><?php echo ($result["user_gender"]); ?></a></span>
                    <span class="sp4" style="left: 190px;"><?php echo ($result["user_phone"]); ?></span>
                    <span class="sp5" style="left: 330px;"><?php echo ($result["user_age"]); ?></span>
                    <span class="sp5" style="left: 420px;"><?php echo ($result["user_pro_num"]); ?></span>
                    <a href="#" class="sp6 ibtn" rel="<?php echo ($result["cst_id"]); ?>"><i></i></a>
                    <div class="idiv" rel="<?php echo ($result["cst_id"]); ?>" style="display: none;z-index: 99;position: absolute;margin-top:30px;background: #fff;border: 0px silver solid">
                        <ul>
                            <?php if(is_array($result["replies"])): $i = 0; $__LIST__ = $result["replies"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$reply): $mod = ($i % 2 );++$i;?><div class="pro_label">
                                    <span>编号</span><span style="left: 110px">回复内容</span>
                                    <span class="pro_label2" style="left: 180px;">回复用户</span>
                                    <span class="pro_label2">日期</span>
                                </div>
                                <li class="pro_li">
                                    <span class="sp1 cst1" style="left: 15px;"><?php echo ($reply["reply_id"]); ?></span>
                                    <span class="sp3 cst2" style="left: 100px;"><a href="#" title="<?php echo ($reply["reply_conment"]); ?>"><?php echo ($reply["reply_conment"]); ?></a></span>
                                    <span class="sp4 cst3"><?php echo ($reply["user_id"]); ?></span>
                                    <span class="sp5 cst4" style="right: 70px;"><?php echo ($reply["reply_date"]); ?></span>
